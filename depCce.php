...
$s1 = $db->query("SELECT AcctCode, AcctName, FormatCode FROM CuentaFinancieraCE where DepositTiendas = 1");
...
<div class="content">
    <div class="col-md-8 offset-md-2">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="php/guardar_depositoCE.php">
                    <!-- Fecha del depósito ingresada por el usuario -->
                    <div class="form-group">
                        <label>Fecha del Depósito</label>
                        <input type="date" name="DepositDate" class="form-control" required min="2025-09-01"  max="<?= date('Y-m-d') ?>" required>
                    </div>

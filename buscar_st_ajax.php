<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['query'])){
        ...
        $q="SELECT c.DocDate,c.DocNum,c.Filler,c.DocNum_Tr,c.ToWhsCode,CONVERT(varchar, c.LineStatus, 23) AS LineStatus,c.Comments,a.fk_emp,a.nombre
                FROM STORECONTROL.dbo.SotCab_MT AS c 
                INNER JOIN STORECONTROL.dbo.Almacen AS a ON a.cod_almacen=c.ToWHSCode
                WHERE c.DocNum=$query_escapado";
        $r=resp_simdim($q); 

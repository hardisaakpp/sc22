...
<div class="content">
                        ...
                        <div class="card-body">
                            <div class="stat-widget-five">
                                <div class="stat-icon dib flat-color-1">
                                    <a href="cediPickTCE.php?idcab=<?php echo $user->id?>">
    ...
    <div class="text-center">
        <a href="cediGrpLdisCE.php" class="btn btn-secondary mt-2">⬅️ Volver</a>
    </div>
</div>
...
document.getElementById('consultarTransferencias').addEventListener('click', function(e) {
    e.preventDefault();
    hideAllContextMenus();
    window.location.href = "consultarTransferenciasCE.php?idcab=<?php echo $idcab; ?>";
});
...
document.getElementById('crearTransferenciasGrupo').addEventListener('click', async function(e) {
    ...
    try {
        ...
        const resp = await fetch("php/getTransferDataCE.php?idcab=<?= $idcab ?>");
        ...
        for (const docnum in grouped) {
            ...
            const response = await fetch("php/enviar_transferenciaCE.php", {
                method: "POST",
            ...
            if (text.includes("Transferencia creada")) {
                await fetch("php/actualizar_estadoCE.php", {
                    method: "POST",
...
document.getElementById('descargarDocSap').addEventListener('click', function(e) {
    ...
    window.location.href = "descargarDocSapCE.php?idcab=<?php echo $idcab; ?>&docnum=" + encodeURIComponent(selectedDocNum);
});
...
document.getElementById('confirmarRecepcion').addEventListener('click', function(e) {
    ...
    window.location.href = "confirmarRecepcionCE.php?idcab=<?php echo $idcab; ?>&docnum=" + encodeURIComponent(selectedDocNum) + "&id=" + encodeURIComponent(selectedId);
});
...
document.getElementById('confirmarRecepcionGrupo').addEventListener('click', function(e) {
    ...
    window.location.href = "confirmarRecepcionGrupoCE.php?idcab=<?php echo $idcab; ?>";
});
...
document.getElementById('descargarGrupo').addEventListener('click', function(e) {
    e.preventDefault();
    hideAllContextMenus();
    window.location.href = "descargarGrupoCE.php?idcab=<?php echo $idcab; ?>";
});

...
//turnos para select dependiendo es MT o CE
      ...
      when dtmHoraDesde>dtmHoraHasta then
       ...
       AS minTrab
        ...
        where 
        t.intIdTurno in (4,11,12,14,17,15,16,6,11,12,14,17,15,16)  order by 5" );
            ...
            for (i=1;i<7;i++) { //localizar fila
                ...
                for (j=0;j<7;j++) {
                    ...
                    if (mimes==mescal) { 
                        ...
                        "        <h3>"+ midia +"</h3>"+
                        "    </div>"+
                        "    <div class='col oculto-impresion'>"+
  ...
  <table id="diasc" class="table table-bordered" style="border-color: black">
    ...
    <thead>
      <tr id="fila0" class="table-dark"><th></th><th></th><th></th><th></th><th></th><th></th><th></th>
                  <th class='totals'>DIAS LIBRES</th><th>H. TRABAJADAS</th><th>N° HORAS 100%</th><th>OBSERVACION</th></tr>
    </thead>          
    <tbody>
      <tr id="fila1"><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                    <td id='tdl1'></td><td id='htr1'></td><td id='h1c1'></td>
      ...
      <tr id="fila2"><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                    <td id='tdl2'></td><td id='htr2'></td><td id='h1c2'></td>
      ...
      <tr id="fila3"><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                    <td id='tdl3'></td><td id='htr3'></td><td id='h1c3'></td>
      ...
      <tr id="fila4"><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                    <td id='tdl4'></td><td id='htr4'></td><td id='h1c4'></td>
      ...
      <tr id="fila5"><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                    <td id='tdl5'></td><td id='htr5'></td><td id='h1c5'></td>
      ...
      <tr id="fila6"><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
                    <td id='tdl6'></td><td id='htr6'></td><td id='h1c6'></td>
    ...
    <tr id="filaTT" class="table-dark"><th  colspan="6" rowspan="3"></th><th>TOTALES</th>
                    <th id='tdlTT'></th><th id='htrTT'></th><th id='h1cTT'></th><th></th>
    </tr>
    <tr id="filaTT3" class="table-dark oculto-impresion"><th colspan="2"> Horas Requeridas</th>
                    <th id='htrTT3'></th><th id='h1cTT3'></th><th id='obsTT3'></th>
    <tr id="filaTT2" class="table-dark oculto-impresion"><th colspan="2"> Diferencia Horas</th>
                    <th id='htrTT2'></th><th id='h1cTT2'></th><th id='obsTT2'></th>
    </tr>
    
    </tr>
  </tfoot>
  </table>
  <div class="btn-group oculto-impresion" role="group" aria-label="...">
    <button type="button" class="btn btn-outline-warning" onclick="javascript:imprimir()">Imprimir</button>

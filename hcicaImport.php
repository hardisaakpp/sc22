...
echo($fecha, $caja, $mediocobro);

                array_push($arrayCAJA, $caja);
                array_push($arrayMEDIOCOBRO, $mediocobro);
              //  array_push($arrayINGRESO, $ingreso);

...
<?php
   ...
   $sentencia2 = $db->query("select * from vw_turnosEmpMes where mes=".$mes." and anio=".$year." ");
...
<form id="monthformX" method="post" action="" name="headbuscar">
    ...
    <div class="input-group-prepend">
		...
		onclick=this.form.action="turEmpY2.php">
		<input type="submit" name="find" value="Descargar .xlsx" class="form-control"
		onclick=this.form.action="turEmpXlsxAll.php">

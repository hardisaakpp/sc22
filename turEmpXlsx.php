...
$sentencia = $db->query("select  top 1 fk_ID_almacen_turemp
    from	users
    where	username='". $_SESSION['username'] ."' AND fk_ID_almacen_turemp<>0" );
    $regCodCierre = $sentencia->fetchObject();
    $tiendaTuremp = $regCodCierre->fk_ID_almacen_turemp;
...
where mes='".$mes."' and anio='".$year."' and fk_id_almacen='".$tiendaTuremp."' " );

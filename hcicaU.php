...
if ($userAdmin==6) {
    ...
    from cicaHitell  where caja='". $caja ."' and fecha='".$fecha."' " );
...
<!---------------------------------------------->
    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="php/hcicaSave.php" id="frmConteo" method="post" onSubmit="return validate()">    
        ...
        ?>
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='hcica.php?pFecha=<?php echo $fecha ?>&pIdAlmacen=<?php echo $fk_ID_almacen ?>'">

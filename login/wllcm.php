...
<?php include_once "header.php"; ?>
  <div class="content bg-body text-body">
    <h3 class="display-3 text-center">Bienvenido</h3>
    <style>
    ...
    <?php
      if($userAdmin==2){
        $q = "EXEC sp_getStockTotalXAlm $_SESSION[idU]"; // coincidencia
        $r = resp_onedim($q);
        if(count($r)>0){  $xpuntaje1 = $r['Inventario']; $xtransit = $r['WhsCode']; }
        else{ $xpuntaje1 = 0; $xtransit = '.'; }
        $q = "EXEC sp_getStockTransitorio $_SESSION[idU]"; // coincidencia
        $r = resp_onedim($q); ?>        
        <div class="row">
          <div class="container">
            <?php if($xpuntaje1>0){ ?>
              <div class="card">
                <div class="box">
                  <div class="content">
                    ...
                    <h3>Transitoria <?php echo $xtransit; ?></h3>
                    <p> 
                      <?php if($r['ANTIGUEDAD']=='RETRASADO'){ ?>
                        <h5 class="card-title" style=" color: green;"><?php echo $xpuntaje1; ?> unidades recientes</h5>
                        <h5 class="card-title" style=" color: red;"><?php echo $r['OpenQty']; ?> u. pendientes mayor a 48horas</h5>
                      <?php }else{ ?>                                  
                        <h5 class="card-title" style=" color: green;"><?php echo $xpuntaje1; ?> unidades recientes</h5>
                      <?php } ?>                         
              ...
              <div class="card">
                <div class="box">
                  <div class="content">
                    ...
                    <h3>Transitoria <?php echo $xtransit; ?></h3>
                    <p>
                      <h5 class="card-title"><?php echo $xpuntaje1; ?> unidades pendientes</h5>
